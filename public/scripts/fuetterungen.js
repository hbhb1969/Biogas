window.onload = function() {
  ...
  let tbodyLager = document.getElementById("tbodyLager");
  // Tabelle wird in die Variable data ausgelesen
  tbodyLager.onclick = function(e) {
    e = e || window.event;
    let data = [];
  ...
  let tbodyDirekt = document.getElementById("tbodyDirekt");
  // Tabelle wird in die Variable data ausgelesen
  tbodyDirekt.onclick = function(e) {
    e = e || window.event;
    let data = [];
    let target = e.srcElement || e.target;
    while (target && target.nodeName !== "TR") {
